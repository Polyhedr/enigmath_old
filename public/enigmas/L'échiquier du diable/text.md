...
1. 🌶️ Trouvez une stratégie qu'Alice et Bob peuvent mettre en place pour être sûrs de trouver la case mystère. Si Alice est contrainte de modifier une case, existe-t-il une stratégie valable ?

2. 🌶️ Le diable décide de retirer une case de l'échiquier (laissant ainsi $n=63$ cases). La stratégie d'Alice et Bob reste-t-elle valable ? Si Alice est contrainte de modifier une case, existe-t-il une stratégie valable ?

3. 🌶️ Trouvez une stratégie probabiliste, fixée à l’avance entre Alice et Bob (dépendant d’un tirage aléatoire partagé, mais inconnu du diable), telle que la probabilité de réussite soit strictement supérieure à $2^{1.5}-2 \approx 0.8284$, quel que soit le nombre $n \geq 2$ de cases.
